...
def analyze_image_with_gemini(img_obj, assigned_key, max_fast_retries=1):
    ...
    prompt = (
        ...
        "4. Identify the transaction or purchase date printed on the receipt as 'date'.\n"
        "   - Standardize to YYYY-MM-DD if clear, otherwise extract text string.\n"
        "   - CAUTION: Verify date digits carefully. Do not misread the year '2026' as '2024' or '2025'. Double check blurry or stylized numbers against current era context.\n"
